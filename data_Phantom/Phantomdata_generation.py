...
def generate_dataset(name,num_region,num_maxvalue_posi,num_value):
    ...
    with h5py.File(f"./phantomdata/mini_2_{name[0]}_database_{num_region}_{num_maxvalue_posi}_{num_value}.h5", 'a') as data0:
    ...
    with h5py.File(f"./phantomdata/mini_2_{name[1]}_database_{num_region}_{num_maxvalue_posi}_{num_value}.h5", 'a') as data1:
    ...
    with h5py.File(f"./phantomdata/mini_2_{name[2]}_database_{num_region}_{num_maxvalue_posi}_{num_value}.h5", 'a') as data2:
