...
#    "python common_train.py --dataset EXPEAST --model ResOnion_input_softplus --addloss --randomnumseed 42 --lr 0.0001 --device_num 1"
#    "python common_train.py --dataset EXPEAST --model ResOnion_PI --randomnumseed 42 --lr 0.0001 --device_num 1"
